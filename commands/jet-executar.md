...
Depois, para cada task: extraia o brief para arquivo, despache o `jet-implementador`, monte o pacote de diff com `/jet-diff`, despache o `jet-revisor`, e só marque a task no ledger quando os dois vereditos vierem aprovados.
